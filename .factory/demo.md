...
- URL: `https://five-minute-heist.sociobot.in/demo` or local `http://localhost:5173/demo`
...
- Leave: use **Start for real**. This removes demo progress before opening the current daily gallery.
